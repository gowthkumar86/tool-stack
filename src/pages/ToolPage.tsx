...
export default function ToolPage() {
  ...
  return (
    <article className="mx-auto flex max-w-4xl flex-col gap-6 px-4 py-6 md:gap-8">
      <PageSeo
        title={seo.title}
        description={seo.description}
        path={canonicalPath}
      ...
      <header className="space-y-3">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-bold tracking-tight text-foreground md:text-4xl">{tool.name}</h1>
      ...
      <MobileAccordionSection title="How to use">
      ...
      <MobileAccordionSection title="Use cases">
      ...
      {tool.explanation && (
        <MobileAccordionSection title="Why people use this tool">
